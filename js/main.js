...
var App = { init: function() { App.HomepageHeight();
    ...
    $('.responsive').slick({
      ...
      //       var slide_size = parseInt($("#owl-reviews_logo .owl-pagination .owl-page").size())
      //       var slide_current = (parseInt($("#owl-reviews_logo .owl-pagination .owl-page.active").index())+1)
      //         if( slide_current != slide_size ) {
      //             $("#owl-reviews_logo .owl-pagination .owl-page:nth-child("+(slide_current+1)+")").click()
      //         } else {
      //             $("#owl-reviews_logo .owl-pagination .owl-page:nth-child(1)").click()
      //         }
      ...
      // $(".wp-reviews .next").click(function(){
      //   owl.trigger('owl.next');
      // })
      // $(".wp-reviews .prev").click(function(){
